...
namespace Microsoft.VisualStudio.Services.Agent.Worker.Build
{
    public sealed class BuildJobExtension : JobExtension
    {
        ...
        public override string GetRootedPath(IExecutionContext context, string path)
        {
            ...
            string defaultPathRoot = context.GetVariable(Constants.Variables.Build.SourcesDirectory, isFilePath: true) ?? string.Empty;
        ...
        public override void ConvertLocalPath(IExecutionContext context, string localPath, out string repoName, out string sourcePath)
        {
                ...
                SourceProvider != null)
            {
                ...
                sourcePath = IOUtil.MakeRelative(localPath, context.GetVariable(Constants.Variables.Build.SourcesDirectory, isFilePath: true));
            }
        }
